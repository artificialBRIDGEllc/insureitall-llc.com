...
**Sign in this order:** ICA → SOW No. 1 → Design Partner License + Amendment No. 1 → **Exhibit R (Phase R)** → **Exhibit BAA (or its correct substitute — see blocker 3)** → send invoice.
...
| [11-phase-r-regulatory-disclaimers.md](11-phase-r-regulatory-disclaimers.md) | **Strict operating phase.** Agent MUST pass **RA + R0–R16**. Source-locked TPMO/TCPA. No paraphrase. |
...
| [../invoice-IIA-2026-0825.html](../invoice-IIA-2026-0825.html) | **$5,000 due 9 Sep 2026** |
...
5. **No trademark quality control anywhere in the kit** — naked-licensing exposure on BRIDGEt. See [09](09-amendment-no-1-license.md) Item C.
6. **Confirm the actual go-live date** so the ratification line and any USPTO first-use date agree. See [09](09-amendment-no-1-license.md) Item A.

## Send list

Attach only **02, 03, 04 + 09, 08, 10 (as agreed), and the invoice.** Never attach 05, 06, or 07.
